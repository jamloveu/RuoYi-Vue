<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="覆盖率" prop="coverage">
        <el-input
          v-model="queryParams.coverage"
          placeholder="请输入覆盖率"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="packageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="覆盖率" align="center" prop="coverage" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="覆盖率" prop="coverage">
          <el-input v-model="form.coverage" placeholder="请输入覆盖率" />
        </el-form-item>
      </el-form>
